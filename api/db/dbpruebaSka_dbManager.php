...
function getConnection() {
	...
	global $db_pruebaSka_db_Url, $db_pruebaSka_db_User, $db_pruebaSka_db_Pass, $db_pruebaSka_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_pruebaSka_db_Url.";dbname=".$db_pruebaSka_db_DbName, $db_pruebaSka_db_User, $db_pruebaSka_db_Pass);
