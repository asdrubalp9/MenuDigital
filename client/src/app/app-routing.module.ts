...
const routes: Routes = [
    ...
    { path: 'configuracion',  loadChildren: './pages/configuracion/configuracion.module#ConfiguracionModule' , canActivate: [AuthGuard], data:["ADMIN", "GOD"] },
    { path: 'home',  loadChildren: './pages/home/home.module#HomeModule' , canActivate: [AuthGuard] },
    { path: 'menus',  loadChildren: './pages/menus/menus.module#MenusModule' , canActivate: [AuthGuard], data:["ADMIN", "GOD"] },
    { path: 'login',  loadChildren: './pages/ingresar/ingresar.module#IngresarModule' , canActivate: [AuthGuard] },
